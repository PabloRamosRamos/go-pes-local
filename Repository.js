...
function buildSheetDefinitions_() {
  ...
  const defs = {
    ...
    [S.FACT_BENEFICIOS_DETALLE]: ['beneficio_detalle_id', 'organizacion_id', 'org_instrumento_id', 'beneficio_codigo', 'cantidad_anual_capacitaciones', 'cantidad_default_capacitaciones', 'visita_tecnica_estado', 'visita_tecnica_fecha_solicitud', 'visita_tecnica_observacion', 'flujo_inicio_estado', 'alerta_origen_modulo', 'updated_by', 'updated_at'],
    [S.FACT_BENEFICIOS_HITOS]: ['beneficio_hito_id', 'organizacion_id', 'org_instrumento_id', 'beneficio_codigo', 'beneficio_nombre', 'convocatoria_codigo', 'convocatoria_nombre', 'hito_codigo', 'hito_nombre', 'modo_fecha', 'fecha_inicio', 'fecha_fin', 'fecha_referencia', 'descripcion_operativa', 'alerta_clave_flag', 'estado_hito', 'orden_visual', 'updated_by', 'updated_at'],
