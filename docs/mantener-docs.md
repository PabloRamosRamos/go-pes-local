...
| **docs/avance-hitos.md** | Dev lead | Por cambio de hitos | ✅ Activo | Nuevo hito, orden, prerequisito o estado en el catálogo de Avance |
| **docs/alertas.md** | Dev lead | Por cambio de plazos | ✅ Activo | Nuevo umbral/regla de alerta operativa |
| **docs/branding-configuracion.md** | Dev lead | Por nueva config | ✅ Activo | Nueva clave en `CFG_Parametros` o `SystemConfig.js`, cambio de branding |
| **docs/performance.md** | Dev lead | Por optimización | ✅ Activo | Nueva fase/optimización de rendimiento |
| **docs/mensajes-normalizados.md** | Dev | Por mensaje nuevo | ✅ Activo | Nuevo mapeo técnico→operativo en `normalizeUserMessage_` |
...
| **docs/api-interna.md** | Dev (quien escribe la función) | Por función pública nueva | ✅ Activo | Cada función pública sin `_` añadida al backend |
