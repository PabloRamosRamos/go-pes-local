...
function buildSheetDefinitions_() {
  ...
  const defs = {
    ...
    [S.FACT_SOCIOS]: ['socio_id', 'organizacion_id', 'run_socio', 'numero_registro', 'nombre_socio', 'edad', 'cargo', 'direccion_socio', 'ubicacion_socio', 'nombre_comite_origen', 'status_carga', 'updated_by', 'updated_at', 'solicitud_id', 'telefono_socio', 'correo_socio', 'consentimiento', 'fecha_registro', 'vinculo_estado'],
