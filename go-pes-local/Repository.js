...
function buildSheetDefinitions_() {
  ...
  const defs = {
    ...
    [S.RAW_SOCIOS]: ['created_at', 'source', 'user_email', 'organizacion_id', 'run_socio', 'numero_registro', 'nombre_socio', 'edad', 'cargo', 'direccion_socio', 'ubicacion_socio', 'nombre_comite_origen', 'status_carga', 'legacy_source', 'legacy_key', 'solicitud_id', 'grupo_label_origen', 'telefono_socio', 'correo_socio', 'consentimiento', 'fecha_registro', 'vinculo_estado'],
    ...
    [S.FACT_SOCIOS]: ['socio_id', 'organizacion_id', 'run_socio', 'numero_registro', 'nombre_socio', 'edad', 'cargo', 'direccion_socio', 'ubicacion_socio', 'nombre_comite_origen', 'status_carga', 'updated_by', 'updated_at', 'solicitud_id', 'telefono_socio', 'correo_socio', 'consentimiento', 'fecha_registro', 'vinculo_estado', 'grupo_label_origen'],
    ...
    [S.FACT_FONDESE]: ['fondese_id', 'id_edicion', 'organizacion_id', 'nombre_organizacion', 'convocatoria_id', 'linea_producto_id', 'estado_proceso', 'resultado_adj', 'estado_ejecucion', 'estado_rendicion', 'fecha_rendicion', 'observaciones_rendicion', 'checklist_docs', 'fecha_creacion', 'fecha_actualizacion', 'creado_por', 'monto_adjudicado', 'monto_ejecutado'],
